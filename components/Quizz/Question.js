...
const Question = ({ childFunc, index }) => {
  ...
  return (
    <div className="bg-transparent">
      <div className="relative w-full h-1 bg-[#271155] my-8">
        <p className="absolute w-7 h-7 mx-auto bottom-[-12px] bg-white border-2 border-[#271155] rounded-full text-center">{index}</p>
      </div>
      <div className="flex flex-col">
        <input
          className="p-2 bg-transparent outline-none focus:border-2 shadow-md text-white placeholder-white"
        ...
        <textarea
          className="p-2 bg-transparent outline-none focus:border-2 shadow-md text-white placeholder-white"
          onInput={(e) =>
            setResponses({ ...responses, description: e.target.value })
          }
      ...
      <select
        className="px-2 bg-transparent outline-none focus:border-2 text-white"
          ...
          [...Array(parseInt(responses.respNr))].map((_, index) => (
            <div className="flex flex-row" key={index}>
              ...
              <input
                ...
                className="p-2 w-full bg-transparent outline-none focus:border-2 shadow-md text-white placeholder-white"
                type="text"
